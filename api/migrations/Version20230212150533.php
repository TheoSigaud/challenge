 ...
 */
final class Version20230212150533 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE "advertisement" (id INT NOT NULL, owner_id INT DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, photo JSON DEFAULT NULL, properties JSON DEFAULT NULL, city VARCHAR(255) DEFAULT NULL, address VARCHAR(255) DEFAULT NULL, zipcode VARCHAR(5) DEFAULT NULL, date_start DATE DEFAULT NULL, date_end DATE DEFAULT NULL, price INT NOT NULL, status BOOLEAN NOT NULL, PRIMARY KEY(id))');
