 ...
 */
final class Version20230117143427 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE booking ADD advertisement_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_E00CEDDEA1FBF71B');
        $this->addSql('DROP INDEX IDX_E00CEDDE19EB6921');
        $this->addSql('ALTER TABLE "booking" DROP advertisement_id');
